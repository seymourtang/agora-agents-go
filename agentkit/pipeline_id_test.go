...
func TestAgentPipelineIDSendsTopLevelPipelineID(t *testing.T) {
	payload := startPipelineIDSession(t, NewAgent(testAgoraClient(), WithPipelineID("studio-pipeline-id")), basePipelineSessionOptions())
...
func TestSessionPipelineIDOverridesAgentPipelineID(t *testing.T) {
	...
	payload := startPipelineIDSession(t, NewAgent(testAgoraClient(), WithPipelineID("agent-pipeline")), opts)
...
func TestPipelineIDAllowsSingleLLMOverrideWithoutTTSOrASR(t *testing.T) {
	agent := NewAgent(testAgoraClient(), WithPipelineID("studio-pipeline-id")).WithLlm(
...
func TestPipelineIDAllowsMultipleOverridesWithoutASR(t *testing.T) {
	agent := NewAgent(testAgoraClient(), WithPipelineID("studio-pipeline-id")).
...
func TestAgentPipelineIDSurvivesBuilderClone(t *testing.T) {
	agent := NewAgent(testAgoraClient(), WithPipelineID("studio-pipeline-id")).WithTools(true)
